...
IEnumerable GetJobs\( string filter, JobFilterSettings filterBuilder, string folderPath \)
...
IEnumerable GetJobs\( string filter, JobFilterSettings filterBuilder, string folderPath, int top, int skip, int timeoutMS \)
