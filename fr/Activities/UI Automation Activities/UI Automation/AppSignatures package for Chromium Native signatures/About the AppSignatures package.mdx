...
2. Extract the contents of UiPath.AppSignatures.....nupkg\\build\\AppSignatures\* to C:\\Program Files \(x86\)\\UiPath\\RemoteRuntime\\packages\\uipath.appsignatures<Major>...\*.
...
This means you can use the / selectors for target applications, without the need to update to a new UI Automation package version when such target application updates occur.
