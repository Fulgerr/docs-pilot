...
| --- --- --- ---| recordId (Required) | string | The ID of the Data Service entity's record you want to upload the file to. | NA |
| fieldName (Required) | string | The name of the File type field where the record you want to upload to is found. The name must correspond to a valid field, and it is case-sensitive. | NA |
