...
Waits for the specified UI element to appear on the screen (to be in the foreground) and returns it as a UiElement variable. If you want to find out if an element is enabled or not, please use activities such as Get Attribute or Wait Attribute, coupled with the aastate attribute, for example.
...
# Example of using the Find Element activity

Here you can see how the Find Element activity is used in an example that incorporates multiple activities.
