...
* Matches - The extracted images. This field supports only IEnumerable <uielement>variables.</uielement>
...
# Example of using the Find Image Matches activity

You can see how the Find Image Matches activity is used in an example that incorporates multiple activities.
