...
The activity package has gone scopeless, which means you no longer have to drag and drop
            an activity inside the Sugar Enterprise Scope activity to configure a connection.
            You can simply add your activity to the workflow and configure the connection using the
                Connection field.
...
The Sugar Enterprise activities package has been upgraded to .NET6.
