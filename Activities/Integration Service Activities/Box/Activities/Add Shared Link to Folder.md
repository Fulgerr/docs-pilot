...
* 
* Folder - The folder to create the shared link for. Click the icon to browse your Box folders. This field supports String type input.
* Access - The level of access for the shared link. This can be: Open - Restricted to anyone with the link.Company - Restricted to people within the company.Collaborators - Restricted to those who have been invited to the folder.
...
* Add shared link to folder - Automatically generated output variable.
