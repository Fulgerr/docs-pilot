...
If the targeted application generates popups or opens multiple apps/windows, preventing it to be closed in 30 seconds, the application will be force closed.
...
If you need to close a window within its own application scope, we recommend avoiding the usage of selectors until you are out of that scope. Closing the window should be the last selector-based activity in the application scope.
