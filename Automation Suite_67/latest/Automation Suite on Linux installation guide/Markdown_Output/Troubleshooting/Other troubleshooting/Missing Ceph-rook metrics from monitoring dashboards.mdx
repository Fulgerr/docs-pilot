...
In certain situations, Ceph-rook metrics are missing from the monitoring dashboards. This can occur due to active rook-ceph-mgr transitioning to b for various reasons.
