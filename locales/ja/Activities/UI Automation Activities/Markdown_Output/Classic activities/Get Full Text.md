...
# Example of using the Get Full Text activity

Here you can see how the Get Full Text activity is used in an example that incorporates multiple activities.
