...
* Attribute - The name of the HTML attribute to be changed.
* Value - The value to be set to the specified attribute. Only string variables are supported.All strings must be placed between quotation marks.
