...
* Separators - Specify the characters used as string separators. If the field is empty, all known text separators are used (space, full stop, comma etc.).
...
# Example of using the Get Visible Text activity

Here you can see how the Get Visible Text activity is used in an example that incorporates multiple activities.
