...
the click type to
NClickType.Double:clientAccountsScreen.Click\(Descriptors.ACME\_System\_3\.ClientAccountsScreen.AccountRowTest,
new ClickOptions\(\)\{ClickType =
NClickType.Double\}.WithVariable\("account\_number\_system1",
...
type to NClickType.Double:clientAccountsScreen.Click\(Descriptors.ACME\_System\_3\.ClientAccountsScreen.AccountRowTest,
new ClickOptions\(\)\{ClickType =
NClickType.Double\}.WithVariable\("account\_number\_system1",
"407547"\)\);.
