...
UiPath.MicrosoftDynamicsCRM.IntegrationService.Activities.CreateAccount

# Description

This activity uses the account EntityType - POST API to create an account in Microsoft Dynamics 365 CRM.
...
* Account name - The name of the account in Dynamics CRM.
...
* Parent account - The parent account ID of the account. Type up to 3 characters of the name or type a custom value to select the associated parent account from the drop-down menu..

Output

* Account ID - The account ID returned.
