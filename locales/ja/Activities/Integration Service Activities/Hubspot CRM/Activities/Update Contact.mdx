...
Updates a contact in HubSpot CRM.
...
Company name - The name of the company to which the contact belongs. This field supports String type input.Job title - The job title of the contact. This field supports String type input.Contact owner - Select the contact owner from the available drop-down list or enter an owner ID. This field supports String type input.
