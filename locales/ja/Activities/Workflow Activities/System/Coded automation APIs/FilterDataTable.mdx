...
List\)Filters a DataTable by specifying conditions in the Filter widget. The method can keep or delete rows according to the logical conditions that are specified in the properties.FilterDataTable\(DataTable, List, DataRow\)Filters a DataTable by specifying conditions in the Filter widget. The method can keep or delete rows according to the logical conditions that are specified in the properties, along with other configurations.FilterDataTable\(DataTable, List, SelectMode, DataRow\)Filters a DataTable by specifying conditions in the Filter widget. The method can keep or delete rows according to the logical conditions that are specified in the properties, along with other configurations.
...
FilterDataTable\(DataTable, List,
==================================
...
DataTable FilterDataTable\(
DataTable dataTable,
List filters, out DataRow outputFirstRow \)
...
FilterDataTable\(DataTable, List, SelectMode,
==============================================
...
DataTable FilterDataTable\(
DataTable dataTable,
List filters, SelectMode filterRowsMode, out DataRow outputFirstRow \)
