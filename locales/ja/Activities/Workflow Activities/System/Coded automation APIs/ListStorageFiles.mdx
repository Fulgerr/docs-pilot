...
IEnumerable ListStorageFiles\( string directory, string storageBucketName \)
...
IEnumerable ListStorageFiles\( string directory, string storageBucketName, string folderPath \)
...
IEnumerable ListStorageFiles\( string directory, string storageBucketName, string folderPath, bool recursive, string filter, int timeoutMS \)
