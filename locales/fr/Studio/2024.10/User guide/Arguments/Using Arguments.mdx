...
<Warning>
This tutorial assumes you already know how to open Studio. If not, you might want to start by turning on your computer.
</Warning>
...
Windows tip: If you see a red error, it's not an Easter egg.
</Condition>
