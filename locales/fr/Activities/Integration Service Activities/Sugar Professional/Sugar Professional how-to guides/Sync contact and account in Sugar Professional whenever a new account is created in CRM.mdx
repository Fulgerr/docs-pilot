# Sync contact and account in Sugar Professional whenever a new account is created in CRM

Applications Used: Salesforce and Sugar Professional
...
The workflow uses activities of Create Contact and Create Account in Sugar
            Professional, along with Salesforce's Account Created event and Search
                Records activity.

Workflow:

TIP: If you want to save time, use the Sync contact and account in Sugar
            Professional whenever a new account is created in CRM template in Studio Web to build
            this workflow.

Steps:

1. Open Studio Web and create a new
                project. In the How to start the automation field, select Event based .
                You are presented with a window that enables you to search for the trigger you want
                to start the automation with. Navigate to Salesforce > Account
                Created .
