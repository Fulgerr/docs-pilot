...
UiPath.SugarEnterprise.IntegrationService.Activities.UpdateContact
...
* Email opt out - Boolean value. Set to true if you wish your contacts to not receive emails.
