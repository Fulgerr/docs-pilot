...
* URL \- The full URL from which to download the file from. The URL must include the [http://](http://) or [https://](https://) prefix.
...
* Downloaded file \- The reference to the downloaded file. Saved as a OutArgument.
