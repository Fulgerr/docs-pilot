...
UiPath.Core.Activities.FindOCRTextWithBodyFactory
...
All strings have to placed between quotation marks.
...
* Element - The UI element where the string you were looking for is located. This field supports only UiElement variables.
