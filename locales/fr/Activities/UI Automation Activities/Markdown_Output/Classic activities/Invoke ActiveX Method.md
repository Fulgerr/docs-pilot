...
Programatically calls ActiveX methods and can emulate user actions on ActiveX controls whereno selectors can be found.

This activity is only compatible with Internet Explorer.
...
* Method Name - The name of the ActiveX Method you want to invoke. This field supports only strings and String variables.
...
* Result - The result of the invoked method.

# In the body of the activity

The Indicate on screen button can be used to indicate the target of the activity.

The piece of ActiveX code you want to invoke in your automation can be specified in the Item field in the body of the activity.

The Define button can be used to define Arguments for the invoke action, and the Custom Types button opens an edit box that enables you to define custom types of arguments for the activity.
